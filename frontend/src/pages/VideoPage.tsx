  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div>
        ...
        <p className="text-muted-foreground">选择视频模型生成短视频，支持文生视频、首帧图生视频、比例、时长和数量参数。</p>
      </div>
              ...
              <div key={`${video.url}-${idx}`} className="rounded-xl border bg-card shadow-sm overflow-hidden group">
                ...
                <div className="p-3 space-y-1">
                  <div className="flex items-center gap-2 text-xs text-muted-foreground">
                    <span className="bg-muted rounded px-1.5 py-0.5 font-mono">{video.mode === "i2v" ? "I2V" : "T2V"}</span>
